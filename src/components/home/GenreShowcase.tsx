        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {genres.map((genre, index) => (
            <Link
              ...
              className="group relative aspect-[2/1] rounded-2xl overflow-hidden cursor-pointer"
              style={{ 
            ...
            >
              ...
              {/* Border */}
              <div className="absolute inset-0 rounded-2xl border border-border group-hover:border-primary/30 transition-colors" />
            </Link>
          ))}
        </div>
      </div>
