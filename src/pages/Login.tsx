...
const LoginPage = () => {
  ...
  return (
    <PageLayout mainClassName="min-h-screen flex items-center justify-center p-4 sm:p-8">
        ...
        <div className="glass-panel p-5 sm:p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-12 pr-12 h-12 bg-secondary/50 border-border-subtle focus:border-primary"
              />
              <button
                type="button"
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-foreground-subtle">Or continue with</span>
            </div>
          </div>
